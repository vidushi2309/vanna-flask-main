...
def __init__(self, vn, cache: Cache = MemoryCache(),
                    ...
                    logo="https://www.canva.com/design/DAGKjFT7ng0/C0Z_G2upEa5LlmLzB79F8w/edit?utm_content=DAGKjFT7ng0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton",
                    title="Welcome to DATA GURU",
                    subtitle="Your AI-powered copilot for Retrieving Data in Seconds.",
                ...
                return jsonify(
                    {
                        ...
                        "header": "Some Questions for Starters are-:",
                    }
                )
                ...
                return jsonify(
                    {
                        "type": "question_list",
                        "questions": [],
                        "header": "Go ahead and ask your guru a question",
                    }
                )
        ...
        def proxy_vanna_svg():
            remote_url = "https://www.canva.com/design/DAGKjFT7ng0/C0Z_G2upEa5LlmLzB79F8w/edit?utm_content=DAGKjFT7ng0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton"
